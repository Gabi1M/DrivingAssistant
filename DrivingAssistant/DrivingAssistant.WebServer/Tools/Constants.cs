...
namespace DrivingAssistant.WebServer.Tools
{
    public static class Constants
    {
        ...
        public static class DatabaseConstants
        {
            ...
            public const string AddMediaCommand = @"insert into media(processed_id, session_id, user_id, type, filepath, source, description, datetime) values (@processed_id, @session_id, @user_id, @type, @filepath, @source, @description, @datetime) returning id;";
            public const string UpdateMediaCommand = @"update media set processed_id = @processed_id, session_id = @session_id, user_id = @user_id, type = @type, filepath = @filepath, source = @source, description = @description, datetime = @datetime where id = @id";
